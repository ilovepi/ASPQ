...
FromDevice(eth0, PROMISC true, SNIFFER false) -> [0]c0;
...
arpq0 :: ARPQuerier(192.168.1.100, AC:22:0B:C6:71:96) -> out0;
...
rt :: RangeIPLookup(192.168.1.100/32 0,
                127.0.0.1/32 0,
                0.0.0.0/0 1);
...
rt[1]
    -> ToDump(FILENAME "MyDump.pcap", ENCAP IP)
    -> arpq0;

FromHost(fake, 192.168.1.100/32)
